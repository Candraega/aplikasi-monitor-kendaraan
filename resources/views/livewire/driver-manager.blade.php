<div>
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Manajemen Driver</h1>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-600">
                <thead class="text-xs text-gray-700 uppercase bg-gray-100">
                    <tr>
                        <th scope="col" class="px-6 py-3">Nama Driver</th>
                ...
                <tbody>
                    @forelse ($drivers as $driver)
                        <tr class="bg-white border-b hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4">
                                {{ $driver->phone_number ?? 'Tidak ada' }}
                            </td>
                            <td class="px-6 py-4 text-center">
                                <div class="flex items-center justify-center space-x-3">
                                    <button wire:click="edit({{ $driver->id }})" title="Edit Driver"
                ...
                <form wire:submit.prevent="store">
                    <div class="flex items-center justify-between p-4 border-b">
                        <h3 class="text-xl font-bold text-gray-800">
                            {{ $driver_id ? 'Edit Driver' : 'Tambah Driver Baru' }}
                        </h3>
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <input type="text" id="name" wire:model.defer="name" placeholder="Contoh: Budi Santoso"
                        ...
                        <div>
                            <label for="phone_number" class="block text-sm font-medium text-gray-700 mb-1">No. Telepon (Opsional)</label>
                            <input type="tel" id="phone_number" wire:model.defer="phone_number" placeholder="Contoh: 081234567890"
                                class="w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('phone_number') border-red-500 @enderror">
